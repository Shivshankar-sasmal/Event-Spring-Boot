...
<div class="container login-registration">
      <div class="row shadow-lg py-5 m-1">
            <div class="col-12">
                <h2 class="text-center slogan">Password Reset Confirm</h2>
                <hr>
            </div>
                  ...
                  <form method="POST" autocomplete="off">
                              <div class="text-small form-group">
                                      ...
                                      <div id="div_id_username" class="form-group"> 
                                              ...
                                              <div class=""> 
                                                      <input type="password" name="password" value="" autofocus="true" autocapitalize="none" autocomplete="" maxlength="150" class="textinput textInput form-control" required="" id="id_username"> 
                                              </div> 
                                      </div>
                          </div>
                          <div class="form-group mt-4 text-center">
                                <button class="btn btn-outline-primary" type="submit">Password Reset Confirm</button>
                          </div>
                          <hr>
                  </form>
           </div>           
